...
class Migration
{
    ...
    private function isUp($fileName): bool
    {
    ...
    public function down()
    {
        ...
        foreach ($files as $file) {
            ...
            $upFileName = str_replace('_down', '_up', $file);
    ...
    private function getNewFiles(): array
    {
    ...
    private function confirm($message): bool
    {
